...
template <typename T>
inline bool operator<(interval<T> const &a,
                      typename interval<T>::value_type const &b) noexcept {
  return weak_less(a, b);
}
template <typename T>
inline bool operator<(typename interval<T>::value_type const &a,
                      interval<T> const &b) noexcept {
  return weak_less(a, b);
}
template <typename T, typename U>
inline bool operator<=(interval<T> const &a, interval<U> const &b) noexcept {
