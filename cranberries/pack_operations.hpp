...
struct pack_expand : nested_type_class<T> {};
...
template <class>
struct pack_conjunction : std::true_type {};
...
template <class>
struct pack_disjunction : std::false_type {};
...
// template < class T,
//				   template <class, T...> class vPack, T Delim,
// T Head, T... Tail, 					 class ResultPack,
// T... RemainderValues> struct
// value_pack_split_impl< 					 T,
// vPack<T, Head, Tail...>, 					 ResultPack,
// Delim,
//					 RemainderValues...>
//	: nested_type_class<
...
//				   template <class, T...> class vPack, T Delim,
// T
// Head, 					 class ResultPack,
// T... RemainderValues> struct value_pack_split_impl<
// T, 					 vPack<T, Head>,
// ResultPack, 		       Delim,
// RemainderValues...> 	: nested_type_class<
//		std::conditional_t<Head==Delim,
//			pack_push_back_t<vPack<T, RemainderValues...>,
// ResultPack>, 			pack_push_back_t<vPack<T,
// RemainderValues..., Head>, ResultPack>
//	>>
//{};
