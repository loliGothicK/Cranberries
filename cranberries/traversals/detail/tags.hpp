...
constexpr bool is_sentinel_iterator_v =
    std::is_base_of<tag::sentinel_iterator_tag, Iterator>::value;
template <class Iterator>
constexpr bool is_sentinel_traversal_v =
    std::is_base_of<tag::sentinel_traversal_tag, Iterator>::value;
template <class Iterator>
constexpr bool is_view_adaptor_v =
    std::is_base_of<tag::view_tag, Iterator>::value;
template <class Iterator>
constexpr bool is_action_adaptor_v =
    std::is_base_of<tag::action_tag, Iterator>::value;
template <class Iterator>
constexpr bool is_adaptor_v =
    std::is_base_of<tag::adaptor_tag, Iterator>::value;
