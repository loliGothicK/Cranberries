...
public:
	...
	iterator begin() const noexcept { return { std::make_unique<forward_sentinel>(traversal, offset, count) }; }
...
namespace view {
	...
	inline SpanProxy span(size_t offset, size_t count) noexcept { return { offset, count }; }
}
