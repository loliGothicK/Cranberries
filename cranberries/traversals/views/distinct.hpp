...
class Distinct : private tag::sentinel_traversal_tag,
 ...
 public:
  ...
  template <class Trav>
  Distinct(Trav &&traversal) : traversal{std::forward<Trav>(traversal)} {}
...
class Distinct<Traversal, false> : private tag::sentinel_traversal_tag,
