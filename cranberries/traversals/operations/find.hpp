...
template <class T>
class Find : private tag::adaptor_tag, private tag::action_tag {
  T value;
 ...
 public:
  ...
  optional<typename std::decay_t<SentinelRange>::value_type> operator()(
      SentinelRange &&traversal) {
...
template <class Pred>
class FindIf : private tag::adaptor_tag, private tag::action_tag {
  Pred pred;
