...
struct meta_permutations_impl {
  static constexpr size_t value =
      meta_permutations_impl<R, I - 1, Result * I, !(I >= R + 1)>::value;
};
...
struct meta_combinations {
  static constexpr size_t value =
      meta_combinations<N - 1, K, D + 1, Result * N / D, (D + 1 > K)>::value;
};
...
inline constexpr std::uint_fast64_t permutations(std::uint_fast64_t n,
                                                 std::uint_fast64_t r) {
  r = n - r;
...
inline constexpr std::uint_fast64_t combinations(std::uint_fast64_t n,
                                                 std::uint_fast64_t k) {
