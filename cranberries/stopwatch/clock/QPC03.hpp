...
unsigned long long to_micro(tick_type _begin, tick_type _end) {
	...
	return static_cast<unsigned long long>(Elapsed.QuadPart * 1000000 / Frequency.QuadPart);
}
...
unsigned long long to_milli(tick_type _begin, tick_type _end) {
	...
	QueryPerformanceFrequency(&Frequency);
	Elapsed.QuadPart = _end.QuadPart - _begin.QuadPart;
	return static_cast<unsigned long long>(Elapsed.QuadPart * 1000 / Frequency.QuadPart);
}
...
unsigned long long to_min(tick_type _begin, tick_type _end) {
	...
	QueryPerformanceFrequency(&Frequency);
	Elapsed.QuadPart = _end.QuadPart - _begin.QuadPart;
	return static_cast<unsigned long long>(Elapsed.QuadPart / 60. / Frequency.QuadPart);
}
...
unsigned long long to_hours(tick_type _begin, tick_type _end) {
	...
	QueryPerformanceFrequency(&Frequency);
	Elapsed.QuadPart = _end.QuadPart - _begin.QuadPart;
	return static_cast<unsigned long long>(Elapsed.QuadPart / 360. / Frequency.QuadPart);
}
