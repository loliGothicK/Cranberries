...
{
    public class NotifyDictionaryChangingEventArgs<TKey, TValue> : EventArgs
    {
        ...
        public NotifyDictionaryChangingEventArgs( NotifyCollectionChangedAction action )
        {
            _Action = action;
        ...
        public NotifyDictionaryChangingEventArgs( NotifyCollectionChangedAction action, IDictionary<TKey, TValue> items )
        {
            _Action = action;
            if ( ( action == NotifyCollectionChangedAction.Reset ) ||
        ...
        public NotifyDictionaryChangingEventArgs( NotifyCollectionChangedAction action, KeyValuePair<TKey, TValue> item )
        ...
        public NotifyDictionaryChangingEventArgs( NotifyCollectionChangedAction action, TKey key, TValue value )
