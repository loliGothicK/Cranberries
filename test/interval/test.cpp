...
try{
  ...
  unit::make_unit_test_container(unit::default_logger, "comparison tests")
    % unit::assertion::less( interval<>(0,3), interval<>(0,4) )
    % unit::assertion::less( interval<>(0,3), interval<>(3,4) )
    % unit::assertion::less_equal( interval<>(1,2), interval<>(1,2) )
    % unit::assertion::less_equal( interval<>(0,3), interval<>(0,4) )
    ...
    % unit::assertion::greater_equal( interval<>(0,3), interval<>(0,1) )
